...
public class RegularScheduleService {
     ...
     * @return 重複がなければtrue
     */
    public boolean checkRegularSchedule(Integer id,String userId,LocalDate startDate,LocalDate endDate, RegularSchedule regularSchedule) {
     ...
     */
    public List<String> readRegularSchedule(Integer id,String userId,LocalDate startDate,LocalDate endDate){
        List<String> DayOfWeeks = scheduleFindMapper.findRegularSchedule(id,userId,startDate,endDate);
        return DayOfWeeks;
    }
}
