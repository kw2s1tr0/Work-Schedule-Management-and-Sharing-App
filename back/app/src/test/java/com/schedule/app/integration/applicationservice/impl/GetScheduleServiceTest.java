                        ...
                        switch (u) {
                            case 0:
                                ...
                                for (int i = 0; i < users.get(u).schedules().size(); i++) {
                                    switch (i) {
                                        case 0:
                                            assertEquals(LocalDate.of(2025, 1, 13),
                                                    users.get(u).schedules().get(i).date());
                                            assertEquals("在宅勤務",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.REGULAR,
                                                    users.get(u).schedules().get(i).scheduleType());
                                            assertEquals(LocalTime.of(9, 0),
                                                    users.get(u).schedules().get(i).startTime());
                                            assertEquals(LocalTime.of(18, 0),
                                                    users.get(u).schedules().get(i).endTime());
                                            assertEquals("#2196F3",
                                                    users.get(u).schedules().get(i).worktypeColor());
                                            break;
                                        case 1:
                                            assertEquals(LocalDate.of(2025, 1, 14),
                                                    users.get(u).schedules().get(i).date());
                                            assertEquals("出社",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.DEFAULT,
                                                    users.get(u).schedules().get(i).scheduleType());
                                        ...
                                        case 2:
                                            ...
                                            assertEquals("有給休暇",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.IRREGULAR,
                                                    users.get(u).schedules().get(i).scheduleType());
                                            assertEquals(LocalTime.of(9, 0),
                                            ...
                                            break;
                                        case 3:
                                            assertEquals(LocalDate.of(2025, 1, 16),
                                                    users.get(u).schedules().get(i).date());
                                            assertEquals("出社",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.DEFAULT,
                                            ...
                                            break;
                                        case 4:
                                            assertEquals(LocalDate.of(2025, 1, 17),
                                                    users.get(u).schedules().get(i).date());
                                            assertEquals("出社",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.DEFAULT,
                                            ...
                                            break;
                                        case 5:
                                            assertEquals(LocalDate.of(2025, 1, 18),
                                                    users.get(u).schedules().get(i).date());
                                            assertEquals("休日",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.COMMON_REGULAR,
                                                    users.get(u).schedules().get(i).scheduleType());
                                            assertEquals(LocalTime.of(9, 0),
                                                    users.get(u).schedules().get(i).startTime());
                                            assertEquals(LocalTime.of(18, 0),
                                            ...
                                            break;
                                        case 6:
                                            assertEquals(LocalDate.of(2025, 1, 19),
                                                    users.get(u).schedules().get(i).date());
                                            assertEquals("休日",
                                                    users.get(u).schedules().get(i).worktypeName());
                                            assertEquals(ScheduleType.COMMON_REGULAR,
                                    ...
                                    switch (i) {
                                        case 0:
                                            ...
                                            assertEquals(LocalTime.of(10, 0),
                                                    users.get(u).schedules().get(i).startTime());
                                            assertEquals(LocalTime.of(19, 0),
                                                    users.get(u).schedules().get(i).endTime());
                                            assertEquals("#2196F3",
                                                    users.get(u).schedules().get(i).worktypeColor());
                                            break;
