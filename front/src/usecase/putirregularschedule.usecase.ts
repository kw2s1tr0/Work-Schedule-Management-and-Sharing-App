...
export async function PutIrregularScheduleUsecase(
  ...
  const putIrregularScheduleReq: PutIrregularScheduleReq = toreq(putIrregularScheduleForm);
  await put(putIrregularScheduleReq, type);
}

function toreq(putIrregularScheduleForm: PutIrregularScheduleForm): PutIrregularScheduleReq {
