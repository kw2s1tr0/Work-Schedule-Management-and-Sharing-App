...
class ScheduleServiceImplTest {
        ...
        @Test
        @DisplayName("toScheduleSearchRecord - ユーザーIDが全角の場合、半角に変換される")
        void testToScheduleSearchRecord_FullWidthUserId_ConvertsToHalfWidth() {
                // Given
                ScheduleSearchForm form = new ScheduleSearchForm(
                                "００００１", // 全角数字
                                "2025-W01",
                ...
                // Then
                assertEquals("00001", result.userId()); // 半角に変換されている
        }
        ...
        void testToUserEntityList_SchedulePriority_SetsSchedulesCorrectly() {
                ...
                // 非定期スケジュール（最優先）
                IrregularScheduleRecord irregularRecord = IrregularScheduleRecord.builder()
                                .scheduleId(1)
                                ...
                                .build();
                List<IrregularScheduleRecord> irregularRecords = Arrays.asList(irregularRecord);

                // 定期スケジュール
                RegularScheduleRecord regularRecord = RegularScheduleRecord.builder()
                                .scheduleId(2)
                                ...
                                .build();
                List<RegularScheduleRecord> regularRecords = Arrays.asList(regularRecord);

                // デフォルトスケジュール
                DefaultScheduleRecord defaultRecord = DefaultScheduleRecord.builder()
                                .scheduleId(3)
                                ...
                                .build();
                List<DefaultScheduleRecord> defaultRecords = Arrays.asList(defaultRecord);

                UserDefaultScheduleRecord defaultUserRecord = UserDefaultScheduleRecord.builder()
                                .defaultSchedules(defaultRecords)
                                .build();
                List<UserDefaultScheduleRecord> defaultUserRecords = Arrays.asList(defaultUserRecord);

                UserRegularScheduleRecord regularUserRecord = UserRegularScheduleRecord.builder()
                                .regularSchedules(regularRecords)
                                .build();
                List<UserRegularScheduleRecord> regularUserRecords = Arrays.asList(regularUserRecord);

                UserIrregularScheduleRecord irregularUserRecord = UserIrregularScheduleRecord.builder()
                                .irregularSchedules(irregularRecords)
                                .build();
                List<UserIrregularScheduleRecord> irregularUserRecords = Arrays.asList(irregularUserRecord);

                // When
                List<User> result = scheduleService.toUserEntityList(
                                defaultUserRecords, regularUserRecords, irregularUserRecords,
        ...
        void testToUserEntityList_NoMatchingSchedule_AddsScheduleWithDateOnly() {
                ...
                // 空のスケジュールリスト
                UserDefaultScheduleRecord defaultUserRecord = UserDefaultScheduleRecord.builder()
                                .defaultSchedules(new ArrayList<>())
                                .build();
                List<UserDefaultScheduleRecord> defaultUserRecords = Arrays.asList(defaultUserRecord);
                
                UserRegularScheduleRecord regularUserRecord = UserRegularScheduleRecord.builder()
                                .regularSchedules(new ArrayList<>())
                                .build();
                List<UserRegularScheduleRecord> regularUserRecords = Arrays.asList(regularUserRecord);
                
                UserIrregularScheduleRecord irregularUserRecord = UserIrregularScheduleRecord.builder()
                                .irregularSchedules(new ArrayList<>())
                                .build();
                List<UserIrregularScheduleRecord> irregularUserRecords = Arrays.asList(irregularUserRecord);
        ...
        void testToUserEntityList_MultipleDays_CreatesSchedulesCorrectly() {
                ...
                // 月水金のスケジュール
                RegularScheduleRecord mondayRecord = RegularScheduleRecord.builder()
                                .scheduleId(1)
                                .startTime(LocalTime.of(9, 0))
                                .endTime(LocalTime.of(18, 0))
                                .startDate(from)
                ...
                RegularScheduleRecord wednesdayRecord = RegularScheduleRecord.builder()
                                .scheduleId(2)
                                .startTime(LocalTime.of(9, 0))
                                .endTime(LocalTime.of(18, 0))
                                .startDate(from)
                ...
                List<RegularScheduleRecord> regularRecords = Arrays.asList(mondayRecord, wednesdayRecord);
                ...
                List<UserRegularScheduleRecord> regularUserRecords = Arrays.asList(
                                UserRegularScheduleRecord.builder()
                                                .regularSchedules(regularRecords)
                                                .build());
